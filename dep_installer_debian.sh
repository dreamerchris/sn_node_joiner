...
sudo apt -qq install -y snapd build-essential moreutils tree >/dev/null && echo "snapd build-essential moreutils tree installed!" || echo "ERROR some or all failed to install! (snapd build-essential moreutils tree)"
